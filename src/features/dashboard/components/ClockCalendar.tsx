...
export default function ClockCalendar() {
  ...
  const dateString = selectedDate.toLocaleDateString('fr-FR', dateOptions).replace(/\./g, '') || '';
        ...
        <div id="calendar-content">
          <div className="calendar-header">
            ...
            <div id="calendar-month-year">
              {calendarDate ? new Intl.DateTimeFormat('fr-FR', { month: 'long', year: 'numeric' }).format(calendarDate) : ''}
            </div>
